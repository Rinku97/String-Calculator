...
import javaImplementation.StringCalculator7;

public class StringCalculatorTest7 {
	
	@Test
	public void emptyString() {
		assertEquals(0,StringCalculator7.Add(""));
	}
	
	@Test
	public void singleValue() {
		assertEquals(1,StringCalculator7.Add("1"));
	}
	
	@Test
	public void doubleValue() {
		assertEquals(3,StringCalculator7.Add("1,2"));
	}
...
//	} 
	...
	public final void handleNewLine() {
		assertEquals(6,StringCalculator7.Add("1\n2,3"));
	}
	
	@Test
	public void shouldAcceptCustomDelimeter() {
		assertEquals(1+2,StringCalculator7.Add("//;\n1;2"));
	}
	
	@Test
	public final void throwExceptionWhenNegativeNumberOccured() {
		Assertions.assertThrows(RuntimeException.class, () -> StringCalculator7.Add("10,5,55,-1"));
	}
	...
	public final void multipleNegativeNumberShowExceptionMessage() {
		...
		try {
			StringCalculator7.Add("1,2,-5,-8,6,3");
	...
	public final void numberGreaterThan1000beIgnored() {
		assertEquals(2,StringCalculator7.Add("2,1001"));
	}
